    ...
    <Container fluid className="home-about-section" id="about">
      <Container>
        <Row>
         ...
         While persuing my Electrical Engineering degree course , I fell in love with programming and I have at least learnt
              something, I think… 🤷‍♂️
              <br />
              ...
              <i>
                <b className="purple">programming Launguages projects and React </b> and
